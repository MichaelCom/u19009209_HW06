...
using u19009209_HW06.Models;
using u19009209_HW06.Models.ViewModels;
using PagedList;
using System.Security.Cryptography;

namespace u19009209_HW06.Controllers
{
    public class productsController : Controller
    {
        ...
        public JsonResult BarChartData()
        {
            ...
            _chart.labels = data.Select(x => x.order.shipped_date.ToString()).ToArray();
